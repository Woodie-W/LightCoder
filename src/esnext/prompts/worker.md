...
Do not use `/` or any absolute filesystem path when reading, searching, or listing files.
...
Do not use `/` or absolute paths for deliverables, notes, reports, figures, or any other files you write inside the workspace.
